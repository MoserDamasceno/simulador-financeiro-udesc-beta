	function createSwals () {

		$('.segment-delete').on('click', function (e) {
			e.preventDefault();
			var id = $(this).attr('data-id');
			var company = $(this).attr('data-company');
	
			swal({
				title: "Desassociar segmento",
				text: "Você tem certeza que deseja desassociar este segmento?",
				type: "warning",
				...
				window.location = base_url('segmentation/delete/' + id) + '?company=' + company;
			});
		});
		...
		$('.service-delete').on('click', function (e) {
			...
			swal({
				...
				text: "Você tem certeza que deseja apagar este serviço?",
				type: "warning",
				showCancelButton: true,
				confirmButtonColor: "#DD6B55",
				confirmButtonText: "Sim, por favor!",
				...
				window.location = base_url('service/delete/' + id);
			});
		});
		...
		$('.plan-delete').on('click', function (e) {
			...
			swal({
				...
				window.location = base_url('plan/delete/' + id);
			});
		});
		...
		$('.field-delete').on('click', function (e) {
			...
			swal({
				...
				text: "Você tem certeza que deseja apagar este campo personalizado?",
				type: "warning",
				showCancelButton: true,
				confirmButtonColor: "#DD6B55",
				confirmButtonText: "Sim, por favor!",
				...
				window.location = base_url('field/delete/' + id);
			});
		});
	
		$('.company-sync').on('click', function (e) {
			e.preventDefault();
			var id = $(this).attr('data-id');
			swal({
				title: "Atualizar dados da empresa de acordo com a receita",
				text: "Você tem certeza que quer atualizar os dados desta empresa?",
				type: "warning",
				showCancelButton: true,
				confirmButtonColor: "#DD6B55",
				confirmButtonText: "Sim, por favor!",
				...
				window.location = base_url('company/sync/' + id);
			});
		});
		...
		$('.company-delete').on('click', function (e) {
			...
			swal({
				...
				text: "Você tem certeza que deseja apagar este empresa?",
				type: "warning",
				showCancelButton: true,
				confirmButtonColor: "#DD6B55",
				confirmButtonText: "Sim, por favor!",
				...
				window.location = base_url('company/delete/' + id);
			});
		});
	}
...
$(".spark-pie-chart").each(function(){
	...
	$('#pagseguro-form.active').on('submit', function(e) {
		e.preventDefault();
		
		swal({
			title: "Você tem que certeza que quer mudar de plano?",
			text: "Sua assinatura !",
			type: "warning",
			showCancelButton: true,
			confirmButtonColor: "#DD6B55",
