...
<aside class="rightbar">
			...
			<div class="coversation-toolbar">
				...
				<div class="active-conversation">
					<div class="chat-avatar">
						<img src="<?php echo assets_url() ?>images/moser.jpg" alt="user">
					</div>
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="chat">
						...
						<li>
							<div data-trigger="hover" title="Robertoortiz" data-content="<div class='chat-user-info'>
								<div class='chat-user-avatar'>
									<img src='<?php echo assets_url() ?>images/moser.jpg' alt='Avatar'>
								</div>
							...
							" data-placement="left"><span class="chat-avatar"><img src="<?php echo assets_url() ?>images/moser.jpg" alt="Avatar"></span><span class="chat-u-info">Adellecharles<cite>New York</cite></span>
						</div>
				...
				<li class="chat-u-away">
					<div data-trigger="hover" title="Mikeluby" data-content="<div class='chat-user-info'>
						<div class='chat-user-avatar'>
							<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/mikeluby.jpg' alt='Avatar'>
						</div>
						<div class='chat-user-details'>
							<ul>
								<li>Status: <span>Online</span></li>
			...
			<li class="chat-u-busy">
				<div data-trigger="hover" title="Joostvanderree" data-content="<div class='chat-user-info'>
					<div class='chat-user-avatar'>
						<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/joostvanderree.jpg' alt='Avatar'>
					</div>
					<div class='chat-user-details'>
						<ul>
							<li>Status: <span>Online</span></li>
	...
	<ul class="chat-user-list">
		<li>
			<div data-trigger="hover" title="Kevinthompson" data-content="<div class='chat-user-info'>
				<div class='chat-user-avatar'>
					<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/Kevinthompson.html' alt='Avatar'>
				</div>
				<div class='chat-user-details'>
					<ul>
						<li>Status: <span>Online</span></li>
	...
	<li class="chat-u-online">
		<div data-trigger="hover" title="Mds" data-content="<div class='chat-user-info'>
			<div class='chat-user-avatar'>
				<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/mds.jpg' alt='Avatar'>
			</div>
			<div class='chat-user-details'>
				<ul>
					<li>Status: <span>Online</span></li>
...
<li>
	<div data-trigger="hover" title="Mko" data-content="<div class='chat-user-info'>
		<div class='chat-user-avatar'>
			<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/mko.jpg' alt='Avatar'>
		</div>
		<div class='chat-user-details'>
			<ul>
				<li>Status: <span>Online</span></li>
...
<li>
	<div data-trigger="hover" title="Coreyweb" data-content="<div class='chat-user-info'>
		<div class='chat-user-avatar'>
			<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/coreyweb.jpg' alt='Avatar'>
		</div>
		<div class='chat-user-details'>
			<ul>
				<li>Status: <span>Online</span></li>
...
<li>
	<div data-trigger="hover" title="Amarkdalen" data-content="<div class='chat-user-info'>
		<div class='chat-user-avatar'>
			<img src='<?php echo assets_url() ?>libraries/westilo-admin/images/avatar/amarkdalen.jpg' alt='Avatar'>
		</div>
		<div class='chat-user-details'>
			<ul>
				<li>Status: <span>Online</span></li>
				...
				<div class="activities-details">
					...
					<div class="activities-post">
						<ul class="new-user-lists">
							...
							<li><a href="#"><img src="<?php echo assets_url() ?>images/moser.jpg" alt="image"></a></li>
							<li><a href="#" class="more-list"><i class="zmdi zmdi-more-horiz"></i></a></li>
						</ul>
					</div>
				</div>
